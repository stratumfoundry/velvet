...
export './src/commands/install/install_command.dart';
export './src/commands/list/list_command.dart';
export './src/commands/make_route/make_route_command.dart';
export './src/commands/plugin/discovery/plugin_discovery_command.dart';
export './src/commands/pub/pub_command.dart';
export './src/core/container.dart';
export './src/core/create_velvet_cli.dart';
export './src/core/velvet_args.dart';
...
export './src/resources/package_config_resource.dart';
export './src/resources/pubspec_resource.dart';
export './src/resources/velvet_yaml_resource.dart';
export './src/services/package_config.dart';
